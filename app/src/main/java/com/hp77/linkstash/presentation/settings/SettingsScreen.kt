                                ...
                                Column(
                                    ...
                                    if (state.isEditingGitHubRepo) {
                                        ...
                                        OutlinedTextField(
                                            ...
                                            onValueChange = {
                                                viewModel.onEvent(
                                                    SettingsScreenEvent.UpdateTempGitHubRepoName(
                                                        it
                                                    )
                                                )
                                            },
                                        ...
                                        OutlinedTextField(
                                            ...
                                            onValueChange = {
                                                viewModel.onEvent(
                                                    SettingsScreenEvent.UpdateTempGitHubRepoOwner(
                                                        it
                                                    )
                                                )
                                            },
                ...
                text = {
                    Column(
                        ...
                        OutlinedTextField(
                            ...
                            onValueChange = {
                                viewModel.onEvent(
                                    SettingsScreenEvent.UpdateHackerNewsUsername(
                                        it
                                    )
                                )
                            },
                        ...
                        OutlinedTextField(
                            ...
                            onValueChange = {
                                viewModel.onEvent(
                                    SettingsScreenEvent.UpdateHackerNewsPassword(
                                        it
                                    )
                                )
                            },
